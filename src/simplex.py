...
print(f"Valor ótimo de x_1: {resultado.x[0]}")
print(f"Valor ótimo de x_2: {resultado.x[1]}")
print(f"Valor ótimo de x_3: {resultado.x[2]}")
print(f"Valor ótimo de x_4: {resultado.x[3]}")
print(f"Valor ótimo de x_5: {resultado.x[4]}")
print(f"Valor ótimo de x_6: {resultado.x[5]}")
print(f"Valor ótimo de x_7: {resultado.x[6]}")
print(f"Valor máximo de L (lucro): R$ {-resultado.fun}")